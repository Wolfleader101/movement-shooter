...
namespace ScriptableObjects.Inventory
{
    ...
    public class Inventory : ScriptableObject
    {
        ...
        [ShowInInspector] private List<InventoryItem> _items;
        ...
        public int RemoveItem(BaseItem item, int itemCount)
        {
            ...
            var inventoryItems = _items.FindAll(invItem => invItem.Item.Equals(item))
                .OrderByDescending(invItem => invItem.ItemCount).ToList();
